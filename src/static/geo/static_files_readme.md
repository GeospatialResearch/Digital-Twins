...
Each tiff must have a style file (`.sld`) with the same name beside it. You can find examples and documentation at https://docs.geoserver.org/main/en/user/styling/sld/cookbook/rasters.html.
