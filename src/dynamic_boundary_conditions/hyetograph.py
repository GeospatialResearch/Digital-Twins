...
def main():
    ...
    hirds_rainfall_data_to_db.rain_depths_to_db(engine, catchment_polygon, file_path_to_store, idf=False)
    hirds_rainfall_data_to_db.rain_depths_to_db(engine, catchment_polygon, file_path_to_store, idf=True)
