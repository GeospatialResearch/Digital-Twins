...
from eddie_floodresilience.dynamic_boundary_conditions.rainfall import rainfall_model_input
...
class RainfallModelInputTest(unittest.TestCase):
    ...
    @patch("eddie_floodresilience.dynamic_boundary_conditions.rainfall.rainfall_model_input.sites_voronoi_intersect_catchment")
