...
class GeoFabricsTest(unittest.TestCase):
    ...
    LIDAR_SIZES = {
        ...
        "ot_CL2_BW24_2014_1000_4027.laz": 721892,
        "ot_CL2_BW24_2014_1000_4125.laz": 1903671,
        "ot_CL2_BW24_2014_1000_4126.laz": 4296526,
        "ot_CL2_BW24_2014_1000_4127.laz": 1053567,
        DATASETS[0] + "_TileIndex.zip": 64716,
    }
    ...
    def setUpClass(cls):
        ...
        test_path = pathlib.Path().cwd() / pathlib.Path("tests/test_run_geofabrics")
        ...
        logging.info("In test_run_geofabrics.py")
        ...
        cls.results_dir = cls.cache_dir / cls.instructions["data_paths"]["subfolder"]
        cls.tearDownClass()
        ...
        cls.instructions["data_paths"]["local_cache"] = cls.cache_dir
